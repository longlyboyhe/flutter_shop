...
class ScreenUtil {
  static const int designWidth = 375; //设计稿宽度
  ...
  void init(BuildContext context) {
    ...
    _tabBarHeight = kTextTabBarHeight;
  ...
  ///TabBar高度
  static double get tabBarHeight => _tabBarHeight;
  ...
  Sp(int fontSize, [allowFontScaling = true]) => allowFontScaling
