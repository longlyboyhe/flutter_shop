...
class CustomeCupertinoPicker extends StatefulWidget {
  ...
  CustomeCupertinoPicker.builder({
    Key key,
    this.diameterRatio = _kDefaultDiameterRatio,
    this.backgroundColor = _kDefaultBackground,
    this.offAxisFraction = 0.0,
  ...
  @override
  State<StatefulWidget> createState() => _CustomeCupertinoPickerState();
}

class _CustomeCupertinoPickerState extends State<CustomeCupertinoPicker> {
  ...
  @override
  void didUpdateWidget(CustomeCupertinoPicker oldWidget) {
