...
//    }
    return GestureDetector(
      onTap: () {
        routePagerNavigator(context, GoodsDetailsPage(goodsItemModel.spuId));
      },
      child: Column(
                ...
                children: <Widget>[
                      ...
                      ? Container(
                          ...
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                  image: AssetImage("images/good_stock_bg.png"),
                                  fit: BoxFit.fill)),
                          child: Text(
                            "${goodsItemModel.quantity}个货源",
                  ...
                  Expanded(
                      child: FadeInImage(
                          fit: BoxFit.contain,
                          placeholder:
                              AssetImage("images/default_good_image.png"),
                          image: NetworkImage(
                              StringUtils.getImageUrl(goodsItemModel.imgUrl))))
//                  Expanded(
//                      child: Image.network(
//                    StringUtils.getImageUrl(goodsItemModel.imgUrl),
...
//              ),
          ...
          Row(
            ...
            children: <Widget>[
              Text(
                goodsItemModel.marketPrice != null
                    ? "￥${goodsItemModel.marketPrice}"
                    : "0.00",
                style: TextStyle(
