...
///
///WebUrl 网页
enum UMShareMediaType { Misuc, Video, WebUrl }
...
class UMengShare {
  ...
  static const MethodChannel _channel =
      const MethodChannel('com.dislux.yshangflutter/UMengShare');
  ...
  static Future<dynamic> shareImageWithMenu(String thumb, String image) async {
    Map<dynamic, dynamic> result = await _channel
        .invokeMethod('shareImageWithMenu', {"thumb": thumb, "image": image});
    return result;
  }
  ...
  static Future<dynamic> shareMediaWithMenu(UMShareMediaType type, String title,
      String desc, String thumb, String link) async {
    print("shareMediaWithMenushareMediaWithMenu");
  ...
  ///
  /// 返回参数说明 bool
  static Future<dynamic> checkInstall(UMPlatform platform,
  ...
  static Future<dynamic> share(
      String price, String name, String size, List<String> images) async {
    Map<dynamic, dynamic> result = await _channel.invokeMethod('share',
        {"price": price, "name": name, "size": size, "images": images});
    return result;
  }
}
