...
class _SnackBarState extends State<CommonSnackBar> {
  @override
...
Widget buildClicks(Widget child, BuildContext context) {
  return new InkWell(
    child: child,
    onTapDown: (details) {
      ToastUtil.showToast(context, 'onTapDown');
      ...
      final snackBar = new SnackBar(
        ...
        action: new SnackBarAction(
          ...
          label: '取消',
          onPressed: () {
            ToastUtil.showToast(context, '关闭了SnackBar');
          },
        ),
      );
    ...
    onTap: () {
      ToastUtil.showToast(context, 'onTap');
    },
  );
}
