...
class CommonSimpleDialog extends StatefulWidget {
  @override
  _SimpleDialogState createState() => new _SimpleDialogState();
}

class _SimpleDialogState extends State<CommonSimpleDialog> {
  @override
...
Widget showDialogItemsClick(Widget child, String msg, BuildContext context) {
  return new InkWell(
    ...
    onTap: () {
      ...
      ToastUtil.showBottomToast(context, "关闭了Dialog$msg");
    },
  );
}
